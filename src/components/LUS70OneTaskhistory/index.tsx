...
export default function LUS70OneTaskhistory({
  rajesh = "Rajesh",
  onTime = "On - Time",
  tags = "Complaint",
  five = "5",
    ...
    <div {...props}>
      <div className="flex items-center justify-between gap-5 self-stretch">
        <div className="flex w-[70%] items-center justify-center gap-1">
          <div className="flex w-full items-center justify-center gap-[5px] rounded bg-gray-100">
          ...
          <Button color="green_A700" shape="round" className="min-w-[76px] !rounded-[11px] font-montserrat">
            {onTime}
          </Button>
          <Text
            as="p"
        ...
        <div className="flex w-[12%] items-center justify-center gap-1 rounded-[10px] bg-green-A700 p-0.5">
          <Heading as="h2" className="!text-white-A700">
            {five}
          </Heading>
          <Img src="images/img_star_9_12x12.svg" alt="image" className="h-[12px] w-[12px] rounded-[1px]" />
        </div>
      </div>
